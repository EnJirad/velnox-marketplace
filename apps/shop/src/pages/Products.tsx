...
const demoProducts: Product[] = [
  {
    ...
    description: "Hand-crafted ceramic vase", shortDescription: "Hand-crafted modern vase",
    ...
    images: [{ id: "i1", productId: "1", url: "", alt: "Vase", sortOrder: 0 }],
    createdAt: "", updatedAt: "",
  },
  {
    id: "2", shopId: "s2", name: "Organic Cotton Tote Bag", slug: "cotton-tote",
    description: "Sustainable everyday tote", shortDescription: "Sustainable everyday tote",
    ...
    images: [{ id: "i2", productId: "2", url: "", alt: "Tote", sortOrder: 0 }],
    createdAt: "", updatedAt: "",
  },
  {
    id: "3", shopId: "s3", name: "Walnut Desk Organizer", slug: "desk-organizer",
    description: "Premium walnut organizer", shortDescription: "Premium walnut organizer",
    ...
    images: [{ id: "i3", productId: "3", url: "", alt: "Organizer", sortOrder: 0 }],
    createdAt: "", updatedAt: "",
  },
  {
    id: "4", shopId: "s1", name: "Hand-Poured Soy Candle", slug: "soy-candle",
    description: "Premium soy wax candle", shortDescription: "Cedar & vanilla candle",
    ...
    shop: { id: "s1", sellerId: "sel1", name: "Artisan Studio", slug: "artisan-studio", description: null, logo: null, cover: null, rating: 4.9, productCount: 48, createdAt: "" },
    images: [{ id: "i4", productId: "4", url: "", alt: "Candle", sortOrder: 0 }],
    createdAt: "", updatedAt: "",
  },
  {
    id: "5", shopId: "s4", name: "Stainless Steel Water Bottle", slug: "water-bottle",
    description: "Double-wall insulated", shortDescription: "Insulated water bottle",
    ...
    images: [{ id: "i5", productId: "5", url: "", alt: "Bottle", sortOrder: 0 }],
    createdAt: "", updatedAt: "",
  },
  {
    id: "6", shopId: "s2", name: "Linen Throw Pillow", slug: "linen-pillow",
    description: "Soft stonewashed linen", shortDescription: "Stonewashed linen pillow",
    ...
    shop: { id: "s2", sellerId: "sel2", name: "Eco Goods", slug: "eco-goods", description: null, logo: null, cover: null, rating: 4.7, productCount: 32, createdAt: "" },
    images: [{ id: "i6", productId: "6", url: "", alt: "Pillow", sortOrder: 0 }],
    createdAt: "", updatedAt: "",
  },
  {
    id: "7", shopId: "s3", name: "Bamboo Cutting Board Set", slug: "cutting-boards",
    description: "Set of 3 bamboo boards", shortDescription: "3-piece bamboo set",
    price: 1190, compareAtPrice: 1490, currency: "THB", status: "active", featured: false,
    rating: 4.6, reviewCount: 145, soldCount: 567, categoryId: "c5",
    shop: { id: "s3", sellerId: "sel3", name: "Woodcraft", slug: "woodcraft", description: null, logo: null, cover: null, rating: 4.8, productCount: 56, createdAt: "" },
    images: [{ id: "i7", productId: "7", url: "", alt: "Boards", sortOrder: 0 }],
    createdAt: "", updatedAt: "",
  },
  {
    id: "8", shopId: "s4", name: "Canvas Backpack", slug: "canvas-backpack",
    description: "Heritage-style waxed canvas", shortDescription: "Waxed canvas backpack",
    price: 2190, compareAtPrice: null, currency: "THB", status: "active", featured: true,
    rating: 4.8, reviewCount: 98, soldCount: 234, categoryId: "c2",
    shop: { id: "s4", sellerId: "sel4", name: "Urban Life", slug: "urban-life", description: null, logo: null, cover: null, rating: 4.6, productCount: 78, createdAt: "" },
    images: [{ id: "i8", productId: "8", url: "", alt: "Backpack", sortOrder: 0 }],
    createdAt: "", updatedAt: "",
  },
];
    ...
    async function load() {
      ...
      try {
        const [productsRes, categoriesRes] = await Promise.allSettled([
          productsApi.list({ search: search || undefined, category: category || undefined, featured: featured || undefined, page, pageSize: 12 }),
          categoriesApi.list(),
        ]);
        if (!cancelled) {
          if (productsRes.status === "fulfilled") {
            setProducts(productsRes.value.items);
            setTotal(productsRes.value.total);
          } else {
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">
            {featured ? "Featured Products" : search ? `Results for "${search}"` : "All Products"}
          </h1>
          <p className="mt-1 text-sm text-muted-foreground">
            {total > 0 ? `${total} products available` : "Discover our curated collection"}
          </p>
        </div>
          ...
          <div className="flex flex-wrap items-center gap-2 mb-6">
            ...
            {search && (
              <Badge variant="secondary" className="gap-1">
                Search: {search}
                <button onClick={() => updateParam("search", null)} className="ml-0.5 hover:text-foreground">
                  <X className="h-3 w-3" />
                </button>
              </Badge>
            )}
            {category && (
              <Badge variant="secondary" className="gap-1">
                Category: {category}
                <button onClick={() => updateParam("category", null)} className="ml-0.5 hover:text-foreground">
                  <X className="h-3 w-3" />
                </button>
              </Badge>
            )}
            {featured && (
              <Badge variant="secondary" className="gap-1">
                Featured
                <button onClick={() => updateParam("featured", null)} className="ml-0.5 hover:text-foreground">
                  <X className="h-3 w-3" />
                </button>
              </Badge>
            )}
          ...
          <aside className="lg:w-56 shrink-0">
            <div className="sticky top-24 space-y-6">
                ...
                <div className="space-y-1">
                  <button
                    ...
                    className={`block w-full text-left text-sm px-3 py-1.5 rounded-lg transition-colors ${
                      !category ? "bg-accent/10 text-accent font-medium" : "text-muted-foreground hover:text-foreground hover:bg-muted"
                    }`}
                  >
                    All
                  </button>
                  {categories.map((cat) => (
                    <button
                      ...
                      className={`block w-full text-left text-sm px-3 py-1.5 rounded-lg transition-colors ${
                        category === cat.slug ? "bg-accent/10 text-accent font-medium" : "text-muted-foreground hover:text-foreground hover:bg-muted"
                      }`}
                    >
                      {cat.name}
                    </button>
              ...
              <div>
                ...
                <div className="space-y-1">
                  {["Newest", "Popular", "Price: Low to High", "Price: High to Low"].map((sort) => (
                    <button
                      key={sort}
                      className="block w-full text-left text-sm px-3 py-1.5 rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted transition-colors"
                    >
                      {sort}
                    </button>
                  ))}
