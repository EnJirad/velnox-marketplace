          ...
          <SheetContent side="left" className="w-72">
            <div className="flex flex-col gap-6 mt-6">
              ...
              <nav className="flex flex-col gap-3">
                <Link to="/products" className="text-sm font-medium text-muted-foreground hover:text-foreground" onClick={() => setMobileMenuOpen(false)}>{t("nav.all_products")}</Link>
                <Link to="/products?featured=true" className="text-sm font-medium text-muted-foreground hover:text-foreground" onClick={() => setMobileMenuOpen(false)}>{t("nav.featured")}</Link>
              </nav>
              {isAuthenticated ? (
